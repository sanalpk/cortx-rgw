...
//    store->conf.mc_process_fid = proc_fid.c_str();
    ...
    ldout(cct, 0) << "INFO: motr profile fid:  " << store->conf.mc_profile << dendl;
    ldout(cct, 0) << "INFO: ha addr:  " << store->conf.mc_ha_addr << dendl;
    ldout(cct, 0) << "INFO: process fid:  " << store->conf.mc_process_fid << dendl;
    ldout(cct, 0) << "INFO: motr endpoint:  " << store->conf.mc_local_addr << dendl;
